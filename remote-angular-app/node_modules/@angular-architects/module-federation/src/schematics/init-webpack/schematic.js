...
function infereNxBuilderNames(tree) {
    const dep = (0, dependencies_1.getPackageJsonDependency)(tree, '@nx/angular');
    const useDevServer = dep &&
        dep.version &&
...
function config(options) {
    return function (tree, context) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if ((_e = buildConfig === null || buildConfig === void 0 ? void 0 : buildConfig.options) === null || _e === void 0 ? void 0 : _e.assets) {
                updateAssets();
            }
            ...
            if (options.type === 'legacy') {
                ...
                const webpackConfig = (0, create_config_1.createConfig)(projectName, remotes, relTsConfigPath, projectRoot);
            ...
            if (!((_f = projectConfig === null || projectConfig === void 0 ? void 0 : projectConfig.architect) === null || _f === void 0 ? void 0 : _f.build) || !((_g = projectConfig === null || projectConfig === void 0 ? void 0 : projectConfig.architect) === null || _g === void 0 ? void 0 : _g.serve)) {
            ...
            // }
            if ((_j = (_h = projectConfig === null || projectConfig === void 0 ? void 0 : projectConfig.architect) === null || _h === void 0 ? void 0 : _h['extract-i18n']) === null || _j === void 0 ? void 0 : _j.options) {
